    ...
    <div className="grid md:grid-cols-2 gap-16 items-center relative overflow-hidden p-8 shadow-[0_2px_10px_-3px_rgba(6,81,237,0.3)] rounded-3xl max-w-6xl mx-auto bg-white mt-4 font-[sans-serif] before:absolute before:right-0 before:w-[300px] before:bg-blue-400 before:h-full max-md:before:hidden">
      <div>
        ...
        <p className="text-sm text-gray-500 mt-4 leading-relaxed">
          Need legal advice or have questions about my services? I'm here to
          provide you with expert guidance and support.
        </p>
        ...
        <ul className="mt-4 flex flex-wrap justify-center gap-6">
          <li className="flex items-center text-blue-600">
            ...
            <a
              href="mailto:adv.ananyatiwari@gmail.com"
              target="_blank"
              rel="noopener noreferrer"
              className="text-sm ml-4"
            >
              <strong>adv.ananyatiwari@gmail.com</strong>
            </a>
          </li>
          <li className="flex items-center text-blue-600">
            <svg
            ...
            <a
              href="tel:+919651033350"
              className="text-sm ml-4"
              onClick={(e) => {
                e.preventDefault();
                window.open(`tel:+919651033350`);
              }}
            >
              <strong> (+91) 9651033350 </strong>
            </a>
          </li>
        </ul>
      </div>
      <div className="z-10 relative h-full max-md:min-h-[350px]">
        <iframe
          src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3500.8402925699943!2d77.21322819678954!3d28.664500299999997!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x390cfdc4efad00a7%3A0xdb828d7432c2f86e!2sTis%20Hazari%20Court%20Western%20Wing%20chamber%2097%2098!5e0!3m2!1sen!2sin!4v1735221682533!5m2!1sen!2sin"
          loading="lazy"
